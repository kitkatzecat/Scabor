...
Game.Index = {
	ButtonClick: function(button) {
		...
		if (button == 'new_game') {
			...
			a.innerHTML = '<span class="ui_title font_title noselect">New Game</span><br><span class="noselect font_text">Enter a name for your character:</span><br><input type="text"><br><br><span class="noselect font_text">Choose your character\'s pronouns:</span><br><select><option selected disabled>Pick an option...</option><option>she/her/hers</option><option>he/him/his</option><option>they/them/theirs</option></select><br><br><div class="ui_button font_text noselect">Next</div><div onclick="Game.UI.Hide();Game.Sound.Play(\'click.mp3\');" class="ui_button font_text noselect">Back</div>';
			Game.UI.Show(a);
